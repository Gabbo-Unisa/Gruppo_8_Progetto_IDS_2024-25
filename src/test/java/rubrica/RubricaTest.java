...
class RubricaTest {
    ...
    void testModificaContatto() {
        ...
        Contatto contattoInserito = new Contatto("Francesco", "Rossi", new ArrayList<>(), new ArrayList<>(), "11 dicembre 2024", "Note",true);
        rubrica.aggiungiContatto(contattoInserito);

        //Contatto aggiornato
        Contatto updateContatto = new Contatto("Franco", "Verdi", new ArrayList<>(List.of("3367228745")), new ArrayList<>(), "11 dicembre 2024", "Note",true);


        // Caso 1: Contatto aggiornato già esistente
        Contatto contattoDuplicato = new Contatto("Francesco", "Rossi", new ArrayList<>(), new ArrayList<>(), "11 dicembre 2024", "Note",true);
        ...
        Contatto invalidContatto = new Contatto("Ferdinando13", null, new ArrayList<>(), new ArrayList<>(), "11 dicembre 2024", "Note",false); // Non valido
